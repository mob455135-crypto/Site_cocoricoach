...
const translations = {
  fr: {
    ...
    "coach-b2-title": "Des séances sur-mesure, bâties en quelques clics",
    "coach-b2-desc": "Construisez chaque séance bloc par bloc selon vos méthodes : séries classiques, supersets, circuits, EMOM, AMRAP... Chaque détail est paramétrable pour guider vos athlètes avec précision.",
    "coach-b2-li1": "Tous les formats : superset, circuit, EMOM, AMRAP...",
    "coach-b2-li2": "Paramétrage précis : séries, répétitions, %1RM, temps de repos",
    "coach-b2-li3": "Notes personnalisées par exercice et par athlète",

    "coach-b3-title": "Pilotez votre business comme un entrepreneur",
    "coach-b3-desc": "Votre tableau de bord business concentre tous les indicateurs clés de votre activité de coaching. Suivez vos abonnements actifs, votre revenu mensuel récurrent et votre taux de rétention en un seul regard.",
    "coach-b3-li1": "Revenu mensuel récurrent (MRR) et score business",
    "coach-b3-li2": "Suivi des abonnements actifs, en retard ou expirés",
    "coach-b3-li3": "Indicateurs de rétention et de croissance de votre activité",
  ...
  en: {
    ...
    "coach-b2-title": "Custom sessions built in just a few clicks",
    "coach-b2-desc": "Build each session block by block using your methods: straight sets, supersets, circuits, EMOM, AMRAP... Every detail is configurable to guide your athletes with precision.",
    "coach-b2-li1": "All formats: superset, circuit, EMOM, AMRAP...",
    "coach-b2-li2": "Precise settings: sets, reps, %1RM, rest time",
    "coach-b2-li3": "Custom notes per exercise and per athlete",

    "coach-b3-title": "Run your business like an entrepreneur",
    "coach-b3-desc": "Your business dashboard brings together all the key indicators of your coaching activity. Track active subscriptions, monthly recurring revenue and your retention rate at a glance.",
    "coach-b3-li1": "Monthly recurring revenue (MRR) and business score",
    "coach-b3-li2": "Active, overdue or expired subscription tracking",
    "coach-b3-li3": "Retention and growth indicators for your activity",
