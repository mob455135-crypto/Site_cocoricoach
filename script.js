...
const translations = {
  fr: {
    ...
    // ---- TARIFS ----
    "pricing-title": "Des Grilles Tarifaires Claires",
    "pricing-coach-name": "Cocoricoach",
    "pricing-coach-sub": "Coachs & structures indépendantes",
    ...
    "pricing-club-sub": "Clubs & organisations sportives",
    ...
    "coach-b1-title": "Une bibliothèque d'exercices intégrée",
    "coach-b1-desc": "Fini les programmes sur feuilles volantes. Structurez vos séances grâce à une base de données visuelle et détaillée.",
    "coach-b1-li1": "Filtres par niveau et groupes musculaires",
    "coach-b1-li2": "Fiches techniques complètes",
    "coach-b1-li3": "Intégration directe dans le planning de l'athlète",

    "coach-b2-title": "Gestion centralisée des rendez-vous",
    "coach-b2-desc": "Organisez votre agenda de coaching personnel et la réservation de vos créneaux de salle en quelques clics.",
    "coach-b2-li1": "Vue calendaire globale",
    "coach-b2-li2": "Réservation d'espaces",
    "coach-b2-li3": "Synchronisation des clients",

    "coach-b3-title": "Suivi de la progression athlète",
    "coach-b3-desc": "Visualisez l'évolution de vos athlètes test après test, et ajustez vos programmes en fonction de leurs résultats réels.",
    "coach-b3-li1": "Historique complet des résultats de tests",
    "coach-b3-li2": "Filtres par catégorie (cardio, force, mobilité...)",
    "coach-b3-li3": "Suivi de la progression dans le temps",
  ...
  en: {
    ...
    // ---- PRICING ----
    "pricing-title": "Clear Pricing Plans",
    "pricing-coach-name": "Cocoricoach",
    "pricing-coach-sub": "Coaches & independent organizations",
    ...
    "pricing-club-name": "Cocoricoach Club",
    "pricing-club-sub": "Clubs & sports organizations",
    ...
    "coach-b1-title": "An integrated exercise library",
    "coach-b1-desc": "No more loose paper programs. Structure your sessions with a detailed, visual database.",
    "coach-b1-li1": "Filters by level and muscle group",
    "coach-b1-li2": "Complete technical sheets",
    "coach-b1-li3": "Direct integration into the athlete's schedule",

    "coach-b2-title": "Centralized appointment management",
    "coach-b2-desc": "Organize your personal coaching schedule and book your gym time slots in just a few clicks.",
    "coach-b2-li1": "Global calendar view",
    "coach-b2-li2": "Space booking",
    "coach-b2-li3": "Client synchronization",

    "coach-b3-title": "Athlete progress tracking",
    "coach-b3-desc": "See how your athletes evolve test after test, and adjust your programs based on real results.",
    "coach-b3-li1": "Complete history of test results",
    "coach-b3-li2": "Filters by category (cardio, strength, mobility...)",
    "coach-b3-li3": "Progress tracking over time",
